...
import com.suliman.chatapplication.ResetPasswordActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private TextView Username,Email,forget_password;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forget_password = view.findViewById(R.id.forget_pass);
    ...
    private void uploadImage(){
        ...
        if (imageUri != null){
            ...
            Toast.makeText(getContext(), "Failed no image selected", Toast.LENGTH_SHORT).show();
        }
    }
