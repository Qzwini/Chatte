...
import com.suliman.chatapplication.Adabter.MessageAdapter;
import com.suliman.chatapplication.Fragments.APIService;
import com.suliman.chatapplication.Model.Chat;
import com.suliman.chatapplication.Model.User;
import com.suliman.chatapplication.Notifications.Client;
import com.suliman.chatapplication.Notifications.Data;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.drawable.falla_logo, username+": "+message, "New Message",
                            userid);
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    try {
                        if (chat.getReceiver().equals(fuser.getUid()) && chat.getSender().equals(userid)){
                            HashMap<String, Object> hashe = new HashMap<>();
                            hashe.put("isseen", false);
                            snapshot.getRef().updateChildren(hashe);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
